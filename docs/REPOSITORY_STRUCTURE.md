...
The initial Next.js application scaffold is now present on `cpc/construction`. Domain modules, database integration, authentication, billing, operational workflows, and production deployment configuration will be added only against their approved specifications and in their defined implementation sequence.
